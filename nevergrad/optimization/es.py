...
ES = EvolutionStrategy(recombinations=1, only_offsprings=True, offsprings=60).with_name("ES", register=True)
MixES = EvolutionStrategy(recombinations=1, only_offsprings=False, offsprings=20).with_name("MixES", register=True)
MutDE = EvolutionStrategy(recombinations=1, only_offsprings=False, offsprings=None).with_name("MutDE", register=True)
